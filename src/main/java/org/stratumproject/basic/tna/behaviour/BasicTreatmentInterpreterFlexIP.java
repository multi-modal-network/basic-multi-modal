 ...
 */
final class BasicTreatmentInterpreterFlexIP {
    ...
    private static final ImmutableMap<PiTableId, PiActionId> SET_OUTPUT_ACTIONS =
            ImmutableMap.<PiTableId, PiActionId>builder()
                    .put(P4InfoConstants.INGRESS_TABLE_FLEXIP,
                            P4InfoConstants.INGRESS_TABLE_FLEXIP_SET_OUTPUT)
                    .build();
    private static final ImmutableMap<PiTableId, PiActionId> DROP_ACTIONS =
            ImmutableMap.<PiTableId, PiActionId>builder()
                    .put(P4InfoConstants.INGRESS_TABLE_FLEXIP,
                            P4InfoConstants.INGRESS_TABLE_FLEXIP_DROP)
                    .build();

    BasicTreatmentInterpreterFlexIP(BasicCapabilities capabilities) {
        this.capabilities = capabilities;
    }

    static PiAction mapTableFlexIPTreatment(TrafficTreatment treatment, PiTableId tableId)
