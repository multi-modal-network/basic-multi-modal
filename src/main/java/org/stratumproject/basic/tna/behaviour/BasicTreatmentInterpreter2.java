 ...
 */
final class BasicTreatmentInterpreter2 {
    ...
    private static final ImmutableMap<PiTableId, PiActionId> SET_OUTPUT_ACTIONS =
            ImmutableMap.<PiTableId, PiActionId>builder()
                    .put(P4InfoConstants.BASIC_INGRESS_TABLE2_TABLE2,
                            P4InfoConstants.BASIC_INGRESS_TABLE2_SET_OUTPUT)
                    .build();
    private static final ImmutableMap<PiTableId, PiActionId> DROP_ACTIONS =
            ImmutableMap.<PiTableId, PiActionId>builder()
                    .put(P4InfoConstants.BASIC_INGRESS_TABLE2_TABLE2,
                            P4InfoConstants.BASIC_INGRESS_TABLE2_DROP)
                    .build();

    BasicTreatmentInterpreter2(BasicCapabilities capabilities) {
        this.capabilities = capabilities;
    }

    static PiAction mapTable2Treatment(TrafficTreatment treatment, PiTableId tableId)
