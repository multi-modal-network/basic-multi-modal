 ...
 */
public abstract class AbstractBasicHandlerBehavior extends AbstractHandlerBehaviour {

    protected final Logger log = getLogger(getClass());

    protected BasicCapabilities capabilities;
     ...
     */
    protected AbstractBasicHandlerBehavior(BasicCapabilities capabilities) {
     ...
     */
    protected AbstractBasicHandlerBehavior(BasicCapabilities capabilities, PiPipeconf pipeconf) {
        this.capabilities = capabilities;
     ...
     */
    public AbstractBasicHandlerBehavior() {
        // Do nothing
    }
    ...
    private void setCapabilitiesFromHandler(
        ...
        this.capabilities = new BasicCapabilities(this.pipeconf);
    }
}
